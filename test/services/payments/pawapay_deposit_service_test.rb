...
class Payments::PawapayDepositServiceTest < ActiveSupport::TestCase
  def setup
    @user       = User.create!(email: "pawa#{SecureRandom.hex(4)}@test.com", password: "password123", first_name: "Test", last_name: "User", city: "Test City", country: "CI", diploma: "Master", employment_status: "En emploi")
